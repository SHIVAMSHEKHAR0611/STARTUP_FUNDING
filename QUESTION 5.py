...
of startups and their investment type is Private Equity. Correct spelling of investment types 
are - "Private Equity", "Seed Funding", "Debt Funding", and "Crowd Funding". Keep an eye for
any spelling mistake. You can find this by printing unique values from this column.
There are many errors in startup names. Ignore correcting all, just handle the 
...
plt.bar(inv,val , width = 0.7,color = "cyan" , edgecolor = "blue" )
plt.title('Top Investors - Private Equity')
plt.xticks(rotation = 0) # rotating names in x-axis
plt.xlabel("Investors",fontsize=16)   # labels of x-axis
plt.ylabel("Number of Startups Having Private Equity as Investment",fontsize=12)  # labels of y_axis
